        ...
        - 🚨 unbounded-depth chain排除→level jump 1本化
          ...
          - 🚨 wfs_level_jump→collapse_core再尖鋭化
            ...
            - 🚨 pbody-acc本体(distinguished sets route)
              ...
              - 🚨🤖 collapse補題(D3)+ladder接続(r66でwf RPrel→単一残差 bwo_Wstar_total(Buchholz[1]§2写経、wf厳密同値)、残=bwo_Wstar_total=2.5/2.6/2.7(operB fund-seq+a[n]<a))[r4][0.73][1.11h]
  - 🚨 §8.1 条件 (I) の下での展開規則
      ...
      - 🚨 OTint(値形OT-step)
        ...
        - 🚨 otIII/otIV脚(一ブロック塔4事実へ還元)
          ...
          - 🚨 {OTA1,SETLE1}(condIII/IV共通塔isOT_BP/setle計算)
            ...
            - 🚨🤖 SETLE1_ltJ(r66でHEAD残差へ還元(ot7_SETLE1_ltJ_of_head)、残=HEAD事実 right-spine-terminal bpHeadV(tx′)=ub+master statement)[r8][1.50][3.15h]
