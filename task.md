...
- 🚨🤖 operB が Buchholz の基本列でない(脚注[30]の誤植を誤読。§7.2/§8 の交換則は別の基本列についての定理。停止性定理は operB 非依存なので無傷)
- 🚨 corrections.md の全数監査(⛔operB。残=A29/A33/A34/A37/A38 の再検証のみ)
- ✅ §5 定式化
- 🚨 §6 ペア数列の基本性質
...
- 🚨 §8 停止性（定理は完了。原文カバレッジに残欠）
  ...
  - 🚨 §8.5 条件 (V) の下での展開規則
    ...
    - 🚨 補題（条件 (V) の Joints/FirstNodes と $t_2$ の基本性質）(3)(⛔operB 修正で不要になる見込み)
