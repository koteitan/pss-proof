      ...
      - 🚨 (4-1)(4-2)：slicepeel
        ...
        - 🚨 B2 → part4_1/4_2
          - 🚨 B2-a cond決定
            ...
            - 🚨 cond(I/III/V)
          - 🚨 B2-b clause shape（clause core を Red N に、機械的）
          - 🚨 B2-c add_scb splice（`m_7_2_add_scb_conj3`、最難）
  - 🚨 §8.2 強単項性
    ...
    - 🚨 補題（部分表現の単項成分と $\textrm{Pred}$ の関係）(§8.2 keystone)
      ...
      - 🚨 w-id 討伐 → keystone 組立
        ...
        - ✅ baseU〔`m_8_2_baseU`〕
        - 🚨🤖 cpU=widTrM=chainOK 系、残=`j1eq⟹chainOK`(非局所 admissibility 伝播、workflow)
