#!/usr/bin/env python3
"""r42 validation v2: reuse r32's working gen_oper, collect non-admeq condIV hosts,
report structure split (e1jm1 vs v1) + exchange triple. Progress printed."""
import sys, os, time
...
def main():
    ...
    for seed,mlen,cap,ns,um,vx in (
        (11,12,2500,(1,2,3),4,8),
        (23,12,2500,(1,2),5,9),
        (37,13,2500,(1,2,3),5,9),
        (5,13,2500,(1,2),6,10),
        (7,14,2500,(1,2,3),6,10),
        (13,14,2500,(1,2),7,11),
        (17,15,2500,(1,2,3),7,11),
        (29,15,2500,(1,2),8,12)):
    ...
    eqv=lt=gtv=0; jm2ltj0=0; jm3ltjm1=0; jm2eqjm3=0
    for M in nonad:
        L=Lng(M); j1=L-1
        ...
        jm2ltj0 += (jm2<j0); jm3ltjm1 += (jm3<jm1); jm2eqjm3 += (jm2==jm3)
    pr(f'struct: jm2<j0 {jm2ltj0}/{len(nonad)}  jm3<jm1 {jm3ltjm1}/{len(nonad)}  jm2==jm3 {jm2eqjm3}/{len(nonad)}')
    ...
    for M in sorted(nonad,key=lambda x:Lng(x))[:12]:
        ...
        pr(f'  {fmt(M)} | v1={entry(M,1,j1)} jm2={jm2} j0={j0} jm3={jm3} jm1={jm1} '
           f'e1jm1={entry(M,1,jm1)} e1jm2={entry(M,1,jm2)} e1jm3={entry(M,1,jm3)}')
