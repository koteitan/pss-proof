...
\begin{aligned}
p&::=D_u a
&&\qquad (u\in\mathbb N_\omega,\ a\in T),\\
a&::=(p_0,\ldots,p_{k-1})
...
E_T((p_0,\ldots,p_{k-1}),(q_0,\ldots,q_{\ell-1}))
  &:=E_L([p_0,\ldots,p_{k-1}],[q_0,\ldots,q_{\ell-1}]),\\
E_P(D_ua,D_vb)
  &:=[u=v]\land E_T(a,b),\\
E_L([],[])&:=1,\\
E_L([],q::qs)&:=0,\\
...
\[
\begin{aligned}
R_T(a)&:\quad E_T(a,a)=1,\\
R_P(p)&:\quad E_P(p,p)=1,\\
...
\[
\begin{aligned}
E_T(a,b)=1&\Longrightarrow a=b,\\
E_P(p,q)=1&\Longrightarrow p=q,\\
...
\[
(p_0,\ldots,p_{k-1})<_T(q_0,\ldots,q_{\ell-1})
\quad\Longleftrightarrow\quad
[p_0,\ldots,p_{k-1}]<_L[q_0,\ldots,q_{\ell-1}]
\tag{10}
\]
